...
namespace Countdown
{
    class OperIni
    {
        ...
        //public static bool INIWriteInt(string iniFile, string section, string key, int value)
        //{
        //    string v = value.ToString();
        //    return WritePrivateProfileString(section, key, v, iniFile);
        //}
        //public static int INIReadInt(string iniFile, string section, string key, int defaultValue)
        //{
        //    string defaultValues=defaultValue.ToString();
        //    string  rv=   INIGetStringValue(iniFile, section, key, defaultValues);
        //    return int.Parse(rv);

        //}

        //public static bool INIWriteDouble(string iniFile, string section, string key, double value)
        //{
        //    string v = value.ToString();
        //    return WritePrivateProfileString(section, key, v, iniFile);
        //}
        //public static double INIReadDouble(string iniFile, string section, string key, double defaultValue)
        //{
        //    string defaultValues = defaultValue.ToString();
        //    string rv = INIGetStringValue(iniFile, section, key, defaultValues);
      ...
      /// <returns></returns>
        //public static bool INIWriteBool(string iniFile, string section, string key, bool value)
        //{
        //    string v = "false";
        //  if(value)
        //      v = "true";
        ...
        /// <returns></returns>
        //public static bool INIReadBool(string iniFile, string section, string key, bool defaultValue)
        //{
        //  string defaultValues = defaultValue.ToString();
        // // string rv = INIGetStringValue(iniFile, section, key, defaultValues);
        //  string rv = INIGetStringValue(iniFile, section, key, defaultValues).Trim().ToLower();
        //  if (rv == "false")
        //    return false;
        //  if (rv == "true")
        //    return true;
        ...
        public static bool INIWrite(string iniFile, string section, string key, double value)
        {
            string v = value.ToString();
            return WritePrivateProfileString(section, key, v, iniFile);
        }
        public static double INIRead(string iniFile, string section, string key, double defaultValue)
        {
            try{
                string defaultValues = defaultValue.ToString();
                string rv = INIGetStringValue(iniFile, section, key, defaultValues);
        ...
        public static bool INIWrite(string iniFile, string section, string key, bool value)
        {
            string v = "false";
            if (value)
                v = "true";
        ...
        public static bool INIRead(string iniFile, string section, string key, bool defaultValue)
        {
            string defaultValues = defaultValue.ToString();
            // string rv = INIGetStringValue(iniFile, section, key, defaultValues);
            string rv = INIGetStringValue(iniFile, section, key, defaultValues).Trim().ToLower();
        ...
        public static bool INIWrite(string iniFile, string section, string key, int value)
        {
            string v = value.ToString();
            return WritePrivateProfileString(section, key, v, iniFile);
        }
        public static int INIRead(string iniFile, string section, string key, int defaultValue)
        {
            try
            {
                string defaultValues = defaultValue.ToString();
        ...
        public static bool INIWrite(string iniFile, string section, string key, String value)
        {
            string v = value.ToString();
            return WritePrivateProfileString(section, key, v, iniFile);
        }
        public static String INIRead(string iniFile, string section, string key, String defaultValue)
        {
            string defaultValues = defaultValue.ToString();
            string rv = INIGetStringValue(iniFile, section, key, defaultValues);
            return rv;
